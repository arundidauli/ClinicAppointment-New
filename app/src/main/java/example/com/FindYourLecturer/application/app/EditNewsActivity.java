    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentUser.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(EditNewsActivity.this, "Failed to Connect Database", Toast.LENGTH_LONG).show();
            }
        });

        passAppointmentAdapter = new PassAppointmentAdapter(EditNewsActivity.this, passAppointmentList);
        ...
        passAppointmentView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(EditNewsActivity.this, StatusAppointmentActivity.class);
